                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter first name" value="" name="FirstName">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 pr-1">
                        ...
                        <select class="form-control" name="Roles">
                            @foreach($roles as $r)
                                <option value="{{$r->role_id}}"  @if($r->role_id == 2) selected @endif >{{$r->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
