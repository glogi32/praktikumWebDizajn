window.onload = function(){
    ...
    $("#btnAdd").on("click",function(){
      ...
      console.log($("#tbFname").val())
      console.log($("#tbLname").val())
      console.log($("#tbE_mail").val())
      console.log($("#tbPassword").val())
      console.log($("#tbHidden").val())
      if( id === ""){
...
function fillFromUpdate(data){
  $("#tbHidden").val(data.korisnik_id);
  $("#tbFname").val(data.ime);
  $("#tbLname").val(data.prezime);
  $("#tbE_mail").val(data.email);
...
function filterByBrand(){
  ...
  $.ajax({
    url : "get_all_productsByBrand.php",
    method : "GET",
    dataType : "json",
    data : {
      id : katId
...
function sort(e){
  ...
  if(idSort == "asc"){
    ...
    $.ajax({
      url : "get_all_productsSortAsc.php",
      method : "GET",
      dataType : "json",
      data : {
        id : idSort
    ...
    $.ajax({
    url : "get_all_productsSortDesc.php",
    method : "GET",
    dataType : "json",
    data : {
      id : idSort
  ...
  if(idSort == "pop"){
    ...
    $.ajax({
      url : "get_all_productsSortPop.php",
      method : "GET",
      dataType : "json",
      data : {
        id : idSort
...
function filterByPrice(e){
  ...
  $.ajax({
    url : "get_all_productsByPrice.php",
    method : "GET",
    dataType : "json",
    data : {
      id : cenaId
