    ...
    <div class="container">
      ...
      <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">234</span>
                ...
                <div>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><a href="#"> < 100$ </a>
                             <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">456</span>
                        </li>
                        <li class="list-group-item"><a href="#"> 100$ - 200$ </a>
                             <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">456</span>
                        </li>
                        <li class="list-group-item"><a href="#"> 200$ - 300$ </a>
                             <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">456</span>
                        </li>
                        <li class="list-group-item"><a href="#"> 400$ - 500$ </a>
                             <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">456</span>
                        </li>
                        <li class="list-group-item"><a href="#"> 600$ - 700$ </a>
                             <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">456</span>
                        </li>
                        <li class="list-group-item"><a href="#"> 700$ - 800$ </a>
                             <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">456</span>
                        </li>
                        <li class="list-group-item"><a href="#"> > 800$ </a>
                             <span class="label <?php echo $nizClass[array_rand($nizClass)]; ?> pull-right">456</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <?php
                            if(isset($_GET["id"])){
                                ...
                                $priprema = $konekcija->prepare("SELECT * FROM proizvodi p INNER JOIN slike s ON p.proizvod_id = s.proizvod_id  WHERE p.proizvod_id = ?");

                                
                                try{
                                    $priprema->execute([$idProizvoda]);
                                    $rez = $priprema->fetch();

                                    if(!$rez){
                                        echo "<script>alert('GRESNA NA SERVERU')</script>";
                                    }
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="komentari">
                            ...
                            <?php
                                $priprema = $konekcija->prepare("SELECT tekst,ime,prezime,vreme FROM komentari k INNER JOIN proizvodi p ON k.proizvod_id = p.proizvod_id INNER JOIN korisnici kr ON k.korisnik_id = kr.korisnik_id WHERE k.proizvod_id = ?");
